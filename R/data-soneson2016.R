...
#'
#' @name sb
#' @description This object contains the example data from the \code{\link{iCOBRA}} package reformatted as a
#' \code{SummarizedBenchmark} object. It consists of differential expression results from \code{\link{DESeq2}}
#' \code{\link{edgeR}} and \code{\link{limma}}-voom.
#' @source Example data from the \code{\link{iCOBRA}} package.
