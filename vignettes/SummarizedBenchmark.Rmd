...
1. Bonferroni correction (`p.adjust` w/ `method = "bonferroni"`) (_Dunn, 1961_),
2. Benjamini-Hochberg (`p.adjust` w/ `method = "BH"`) (_Benjamini and Hochberg, 1995_), and
3. Storey's FDR q-value (`qvalue::qvalue`) (_Storey, 2002_).
