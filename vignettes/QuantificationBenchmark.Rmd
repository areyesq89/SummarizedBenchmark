...
extractSRA <- function( sra_accession, exe_path = 'fastq-dump', args = '--split-3 --gzip', outdir = 'fastq', dry_run = FALSE) {
...
colData( allSB )$tissue <- annotation$tissue[match( colData( allSB )$sample, annotation$sample )]
